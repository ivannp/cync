...
#ifndef PROTOBUF_INCLUDED_EncodingConfig_2eproto
#define PROTOBUF_INCLUDED_EncodingConfig_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_EncodingConfig_2eproto 
...
namespace google {
namespace protobuf {
template<> ::sotcore::EncodingConfig* Arena::CreateMaybeMessage<::sotcore::EncodingConfig>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace sotcore {
...
class EncodingConfig : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:sotcore.EncodingConfig) */ {
 public:
  ...
  inline EncodingConfig* New() const final {
    return CreateMaybeMessage<EncodingConfig>(NULL);
  }

  EncodingConfig* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<EncodingConfig>(arena);
  }
...
#endif  // PROTOBUF_INCLUDED_EncodingConfig_2eproto
